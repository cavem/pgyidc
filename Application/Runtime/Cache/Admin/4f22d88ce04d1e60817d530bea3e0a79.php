...
<body>
    <div class="upgrade">
        ...
        <div class="lanwrap w1200">
            <p class="lantt">下次续费日期：<b><?php echo (date("Y-m-d",$info["duetime"])); ?></b> <b style="margin-left:20px;"></b>本次升级周期：<b><?php echo ($zq); ?></b>天   <label style="margin-left:20px;">余额：</label><b class="balance"><?php echo ($balance); ?></b> <b>RMB</b>
        </div>
        <div class="lanwrap w1200">
        ...
        <div class="lanwrap w1200" style="border-top: 1px dotted #60aff6;text-align: right;width:100%;padding:10px 0;position: absolute;bottom: 0;right: 0px;">
            ...
            <input type="hidden" id="vpsid" value="<?php echo ($vpsinfo["vid"]); ?>">
            <input type="hidden" id="cyc" value="<?php echo ($info["cyc"]); ?>">
        </div>
    </div>
</body>
</html>
...
<script>
    $(function(){
        ...
        $('.savesub').click(function(){
            ...
            formdata+='&additionalips='+additionalips+'&customid='+customid;
        ...
        <div class="contain">
            ...
            <div class="edit-line">
                ...
                <select name="serverstate" class="form-control" style="width: 150px;font-size: 12px;">
                    ...
                    <option value="0" <?php if($info.vpsinfo.state == 'setup'): ?>selected<?php endif; ?>>安装中</option>

    ...
    <div class="center-back right-back">
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    <a href="<?php echo U('Home/Index/cloudbuy');?>" target="blank"><button type="button" class="btn btn-info" style="float:left;">购买云主机</button></a>
                    <a href="<?php echo U('Cloud/cloudmanage');?>"><button type="button" class="btn btn-default" style="float: left;margin-left: 10px;">进入前台管理</button></a>
                    <form action="<?php echo U('Cloud/admincdmg');?>" method="post" style="float: right;">
                        <div>
                            <input type="text" name="keyword" value="<?php echo ($keyword); ?>" class="form-control" placeholder="用户ID/ip地址/云主机编号" style="width: 200px;position: relative;top: 1px;">               
                    ...
                    <table class="table table-condensed" style="margin-top: 50px;">
                        ...
                        <tbody>
                            <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                                ...
                                <td><a href="<?php echo U('Officweb/memberlist',array('userid'=>$v['userid']));?>" target="blank">#<?php echo ($v["userid"]); ?></a></td>
                                ...
                                <td style="text-align: right;">
                                    <button onclick="proeditopen(<?php echo ($v["cloudno"]); ?>);" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i> 编辑</button>

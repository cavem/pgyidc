    ...
    <div class="center-back right-back">
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    <ul class="otherul">
                        <a href="<?php echo U('Jdcloud/jdadmincdmg',array('regionid'=>'cn-north-1'));?>"><li <?php if($regionid == 'cn-north-1'): ?>class="onthis"<?php endif; ?>>华北-北京</li></a>
                        <a href="<?php echo U('Jdcloud/jdadmincdmg',array('regionid'=>'cn-south-1'));?>"><li <?php if($regionid == 'cn-south-1'): ?>class="onthis"<?php endif; ?>>华南-广州</li></a>
                        <a href="<?php echo U('Jdcloud/jdadmincdmg',array('regionid'=>'cn-east-1'));?>"><li <?php if($regionid == 'cn-east-1'): ?>class="onthis"<?php endif; ?>>华东-宿迁</li></a>
                        <a href="<?php echo U('Jdcloud/jdadmincdmg',array('regionid'=>'cn-east-2'));?>"><li <?php if($regionid == 'cn-east-2'): ?>class="onthis"<?php endif; ?>>华东-上海</li></a>
                    </ul>
                    ...
                    <?php if($_SESSION['loginuser']['usertype']== 1): ?><a href="<?php echo U('Jdcloud/ipmanage');?>">
                            <button type="button" class="btn btn-default" style="float: left;margin-left: 10px;">公网ip管理</button>
                        </a>
                        <a href="<?php echo U('Jdcloud/jdcloudmanage',array('regionid'=>$regionid));?>">
                            <button type="button" class="btn btn-default" style="float: left;margin-left: 10px;">进入前台管理</button>
                        </a><?php endif; ?>
                    <form action="<?php echo U('Cloud/jdadmincdmg');?>" method="post" style="float: right;">
                        <div>
                    ...
                    <table class="table table-condensed" style="margin-top: 50px;">
                        ...
                        <tbody>
                            ...
                            <?php if(is_array($cloudlist)): $i = 0; $__LIST__ = $cloudlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo U('Officweb/memberlist',array('userid'=>$vo['userid']));?>" target="blank">#<?php echo ($vo["userid"]); ?></a></td>
                                <td>
                                ...
                                <td class="option">
                                    ...
                                    <span class="moreoption" style="display: inline-block;">更多 <i class="fa fa-sort-desc" style="position: relative;top: -1px;"></i>
                                        <ul class="fold-drop">
                                            ...
                                            <li class="">
                                                <a href="javascript:;" <?php if($vo["status"] != 'running'): ?>class="remove"<?php else: ?>class="disableda" title="无法删除主机，请先停止主机"<?php endif; ?>>删除</a>
                                            </li>
                                        </ul>
                                    </span>
                                </td>

             ...
             <div class="topbar-nav-col">
              ...
              <div class="topbar-nav-col">
                <div class="topbar-nav-item">
                  ...
                  <ul>
                    <li><a href="<?php echo U('Blockabroadip/blockabroadip');?>">
                        <span class="fa fa-ban"></span> 
                        <span class="">防御阻断</span> 
                    </a>
                    </li>
                    <li><a href="<?php echo U('Blockabroadip/setips');?>">
...
<link rel="stylesheet" type="text/css" href="/Application/Admin/View/Public/css/layout.css" />
<link rel="stylesheet" type="text/css" href="/Application/Admin/View/Public/css/control_index.css" />
     ...
     <div class="view-product background-color">
        <div class="padding-big background-color">
              ...
              <dl>
                <dt class="padding-big-left lists-border-list clearfix">
                  <div class="title fl padding-big-top padding-big-bottom">
                    <p>HI,<?php echo ($userinfolist["username"]); ?></p>
                    <p class="margin-small-top clearfix">
                      ...
                      <!--通过实名认证-->
                      <a class="button bg-green-deep icon icon-button-green fl margin-left" href="<?php echo U('Userinfo/identificat');?>">通过实名认证</a>
                    </p>
                  </div>
                </dt>
                <dd class="padding-big clearfix">
                  <p class="w50 fl">
                    <i class="fa fa-phone fl" style="margin-top: 3px;"></i>

                    <span class="fl margin-left">手机：
                      <?php echo ($userinfolist["phone"]); ?>
                    </span>
                  </p>
                  <p class="w50 fl">
                    <i class="fa fa-envelope-o fl" style="margin-top: 3px;"></i>

                    <span class="fl margin-left">邮箱：
                        <?php echo ($userinfolist["linkmail"]); ?>
                    </span>
                  </p>
                </dd>
              </dl>
              ...
              <dl>
                <dt class="padding-big lists-border-list clearfix">
                  <div class="fl w50 title">
                    <p>账户余额</p>
                    <p class="margin-small-top clearfix">
                      <span class="fl"><em class="h3 text-red-deep"><?php echo ($balance); ?></em>元</span>
                      <a class="fl margin-left button btn-red text-white"  href="<?php echo U('Userinfo/account');?>">充值</a>
                    </p>
                  </div>
                </dt>
                <dd class="padding-big">
                  <div class="account-class text-hidden">
                    <a href="<?php echo U('Userinfo/account');?>">订单记录</a>
                    <a href="<?php echo U('Userinfo/account');?>">充值记录</a>
                    <a href="<?php echo U('Userinfo/account');?>">消费记录</a>
                  </div>
                </dd>
              </dl>
            </div>
                ...
                <dt class="padding-big lists-border-list clearfix">
                  <div class="fl title">
                    ...
                    <p class="text-sliver text-default margin-small-top">
                      <span style="color: #2f2f2f;">售后客服：</span>
                      <em class="text-golden margin-big-right">QQ：</em><a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=800002004&aty=0&a=0&curl=&ty=1" target="_blank">800002004</a>
                      <em class="text-golden margin-big-right">Tel：</em>0527-84224055
                    </p>
                    <p class="text-sliver text-default margin-small-top">
                        <span style="color: #2f2f2f;">售前客服：</span>
                        <a class="button btn-orange text-white askbtn" style="margin:0;padding: 2px 4px;" href="javacript:;">购机立即咨询</a>
                    </p>
                  </div>
                  <div class="fr">
          ...
          <div class="account-product margin-big-top clearfix">
              <div class="text-box-main padding-big fl mine-product" style="width: 100%;height: 150px;background: url(/Application/Admin/View/Public/img/admin_active.png) #04113b no-repeat center;">
                 <a href="<?php echo U('/Home/Index/newactive');?>" target="_blank" class="btn btn-danger fr" style="margin-top: 25px;font-size: 28px;">查看详情</a>
              </div>
          </div>
          <!--产品-->
          <div class="account-product margin-big-top clearfix">
            <div class="text-box-main padding-big fl mine-product">
              ...
              <div class="mine-product-content clearfix">
                <ul class="w50 fl lists">
                  ...
                  <li class="w70 lists-border-list">
                    <p class="border-list-text">云主机线路一： <em class="orange"><?php echo ($cloudnum1); ?></em> 台
                      <a class="text-main fr" href="<?php echo U('Cloud/cloudmanage');?>">查看</a>
                    </p>
                  <li class="w70 lists-border-list">
                    <p class="border-list-text">云主机线路二： <em class="orange"><?php echo ($cloudnum2); ?></em> 台
                      <a class="text-main fr" href="<?php echo U('Jdcloud/jdcloudmanage');?>">查看</a>
                    </p>
                  </li>
                  <li class="w70 lists-border-list">
                    <p class="border-list-text">物理机： <em class="orange">0</em> 台
                      <a class="text-main fr" href="#">查看</a>
                    </p>
                  </li>
                ...
                <ul class="w50 fl lists">
                  <li class="w80 lists-border-list">
                    <p class="border-list-text">15天内到期的云主机线路一： <em class="orange"><?php echo ($cloudnumdq1); ?></em> 台
                      <a class="text-main fr" href="<?php echo U('Cloud/cloudmanage');?>">查看</a>
                    </p>
                  </li>
                  <li class="w80 lists-border-list">
                      <p class="border-list-text">15天内到期的云主机线路二： <em class="orange"><?php echo ($cloudnumdq2); ?></em> 台
                        <a class="text-main fr" href="<?php echo U('Jdcloud/jdcloudmanage');?>">查看</a>
                      </p>
                  </li>
                  <li class="w80 lists-border-list">
                    <p class="border-list-text">15天内到期的物理机： <em class="orange">0</em> 台
                      <a class="text-main fr" href="#">查看</a>
                    </p>
                  </li>
                </ul>
            ...
            <div class="text-box-main padding-big fl w25">
              <h2 class="h6 margin-big-bottom">公告</h2>
              <ul class="lists">
  ...
  <div class="float-panel-middle" style="display:none;">
      <div style="position: relative;">
          ...
          <ul>
              <li>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=2851391894&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售阿东</span></a>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=2851391907&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售硕硕</span></a>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=2851391890&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售宁宁</span></a>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=3002738725&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售吉祥</span></a>
              </li>
              <li>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=3002725400&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售依一</span></a>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=2851391885&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  销售慧慧</span></a>
              </li>
          </ul>
          <h4 style="text-align:left;margin-left:10px;line-height:25px;border-bottom:2px solid #60aff6;margin-top:20px;">投诉建议</h4>
          <ul>
              <li>
                  <a href="http://wpa.qq.com/msgrd?v=3&uin=3002951580&site=qq&menu=yes" target="blank"><span><img src="/Application/Admin/View/Public/img/qq.png" alt="">  投诉受理</span></a>
              </li>
          </ul>
      </div>
  </div>

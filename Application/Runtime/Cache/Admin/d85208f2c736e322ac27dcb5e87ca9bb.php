        ...
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    ...
                    <?php if($usertype == 1): ?><a href="<?php echo U('admincdmg');?>"><button type="button" class="btn btn-default" style="float: left;margin-left: 10px;">进入后台管理</button></a><?php endif; ?>
                    ...
                    <table class="table table-condensed" style="margin-top: 50px;">
                        ...
                        <tbody>
                            <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                                ...
                                <td>20<?php echo (date("y-m-d",$v["duetime"])); ?></td>

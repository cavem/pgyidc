...
$(function(){
    ...
    $('.otherul li').click(function(){
        $('tbody').html('<tr><td colspan="10" align="center" style="border: 0px;background: rgba(255, 255, 255,0.9);position:relative;width:100%;z-index: 999;"><img src="/Application/Admin/View/Public/img/loading.gif" height="22px;"> 加载中...</td></tr>');
    })
    //解绑
    $('.relieve_bd').click(function(){
        layer.confirm("确认将公网IP ：43.240.1.2从云主机node-sdk-test解绑?", {
            ...
            $.post('/Admin/Jdcloud/deleteinstance','instanceid='+instanceid+"&regionid=<?php echo ($regionid); ?>",function(data,status){
                layer.closeAll();
                if(data=="0"){
    ...
    <div class="center-back right-back">
        <div class="container-fluid">
            <div class="info-center">
                ...
                <div class="page-body">
                    <ul class="otherul">
                        <a href="<?php echo U('Jdcloud/ipmanage',array('regionid'=>'cn-north-1'));?>"><li <?php if($regionid == 'cn-north-1'): ?>class="onthis"<?php endif; ?>>华北-北京</li></a>
                        <a href="<?php echo U('Jdcloud/ipmanage',array('regionid'=>'cn-south-1'));?>"><li <?php if($regionid == 'cn-south-1'): ?>class="onthis"<?php endif; ?>>华南-广州</li></a>
                        <a href="<?php echo U('Jdcloud/ipmanage',array('regionid'=>'cn-east-1'));?>"><li <?php if($regionid == 'cn-east-1'): ?>class="onthis"<?php endif; ?>>华东-宿迁</li></a>
                        <a href="<?php echo U('Jdcloud/ipmanage',array('regionid'=>'cn-east-2'));?>"><li <?php if($regionid == 'cn-east-2'): ?>class="onthis"<?php endif; ?>>华东-上海</li></a>
                    </ul>
                    <a href="<?php echo U('');?>"><button type="button" class="btn btn-info" style="float:left;margin-left: 25px;">申请</button></a>
                    <form action="<?php echo U('');?>" method="post" style="float: right;">
                        <div>
                            <input type="text" name="keyword" value="<?php echo ($keyword); ?>" class="form-control" placeholder="请输入公网IP地址" style="width: 150px;position: relative;top: 1px;">               
                    ...
                    <table class="table table-condensed" style="margin-top: 50px;">
                        ...
                        <tbody>
                            <?php if($iplist[0] == ''): ?><tr><td colspan="10" align="center">无公网IP数据</td></tr><?php endif; ?>
                            <?php if(is_array($iplist)): $i = 0; $__LIST__ = $iplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><span class="ipid"><?php echo ($vo["elasticIpId"]); ?></span></br><span class="ip" style="color: #60aff6;"><?php echo ($vo["elasticIpAddress"]); ?></span></td>
                                <td><?php echo ($vo["provider"]); ?></td>
                                <td>全可用区</td>
                                <td></td>
                                <td><?php echo ($vo["networkInterfaceId"]); ?></td>
                                <td>云主机</td>
                                <td><?php echo ($vo["instanceName"]); ?></td>
                                <td><?php echo ($vo["bandwidthMbps"]); ?> Mbps</td>
                                <td><?php echo ($vo["charge"]["chargeStartTime"]); ?></td>
                                <td class="option">

                ...
                <div class="info-center">
                    ...
                    <div class="page-body">
                        <table class="table table-condensed" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <?php if(is_array($orderlst["list"])): foreach($orderlst["list"] as $key=>$v): ?><tr>
                                    <td><?php echo ($v["nid"]); ?></td>
                                    <td><a href="javascript:void(0);" onclick="orderinfo(<?php echo ($v["nid"]); ?>,<?php echo ($v["id"]); ?>);"><?php echo ($v["id"]); ?></a></td>
                                    <td><?php echo ($v["cname"]); ?></td>
                                    <td><?=($v['status']=="已生效"?"<i class='icon-circle iconsx'></i>&nbsp;":"<i class='icon-circle iconzx'></i>&nbsp;").$v['status']?></td>
                                    <td><?php echo ($v["prodcat"]); ?></td>
                                    <td><?=$v['paycycle']=="月付"?$v['paycycle']:"<font style='color:#FF0000'>".$v['paycycle']."</font>"?></td>
                                    <td><?=date('Y-m-d',strtotime($v['order_end_at']))?></td>
                                    <td><?php echo ($v["preroom"]); ?></td>
                                    <td><?php echo ($v["paytype"]); ?></td>
                                    <td><?=date('Y-m-d',strtotime($v['order_begin_at']))?></td>

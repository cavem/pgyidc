...
<div class="login_box">
    ...
    <div class="form-group">
        <span class="label"><font class="color-primary mr5">*</font>用户名：</span>
        <input placeholder="请输入用户名" name="nickname" type="text" value=""
               class="input-text" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
                    </div>
    <div class="form-group">
    ...
    <div class="mt15">
        <a href="<?php echo U('/admin/login');?>">已有账号登录</a>
    </div>
</form>
      </div>

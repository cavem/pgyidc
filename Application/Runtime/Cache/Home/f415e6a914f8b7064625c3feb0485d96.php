...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">京东云主机</h2>
            <p class="mt20 wow fadeInUp">京东云主机是一种管理便捷、安全可靠的云计算服务单元。您无需为硬件的购买和维护投入精力，可随时创建和释放多台云主机，快速部署应用，并且可根据业务需要扩展计算能力，按需付费，节约成本，帮助您更高效稳定的开展业务。</p>
            <div class="show-more m0 mt30 wow fadeInUp askbtn">立即咨询</div>
            <a href="<?php echo U('Index/jdcloudbuy');?>"><div class="show-more m0 mt30 wow fadeInUp">立即购买</div></a>
        </div>
    </div>
</div>

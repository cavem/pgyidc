              ...
              <div class="navigation-inner">
                <div class="navigation-v3">
                  <ul>
                    ...
                    <li><h2><a href="Index/newactive">最新活动</a></h2></li>
...
.ps-item{width: 260px;padding:25px;height:100%;margin:0 19px;float:left;box-shadow: 3px 3px 5px #bbb;} 
...
.ps-item-btn{width: 123px;height: 33px;margin: 0 auto;padding: 5px 8px;margin-top:25px;font-size: 15px;color: #fff;}
.advance-item{width: 400px;height:200px;float: left;}
.advance-item i{color: #A9A9A9;margin-top: 45px;}
.advance-item-title{font-size: 18px;}
...
.cooper-item{width: 210px;height: 60px;float:left;margin: 10px;background: #fff;box-shadow: 3px 2px 2px #ddd;padding: 4px 8px;}
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active" style="background-image:url(/Application/Home/View/Public/images/slider1.jpg);">
            <div style="position:relative;height:550px;width:1200px;margin:0 auto;">
                <a href="<?php echo U('Index/newserver');?>" style="width: 220px; height: 60px;position: absolute;bottom: 105px;left: 15px;"></a>
            </div>
        ...
        <div class="item" style="background-image:url(/Application/Home/View/Public/images/slider2.jpg);">
            <div style="position:relative;height:550px;width:1200px;margin:0 auto;">
                <a href="<?php echo U('Index/newserver');?>" style="width: 220px; height: 60px;position: absolute;bottom: 105px;left: 15px;"></a>
            </div>
        ...
        <div class="item" style="background-image:url(/Application/Home/View/Public/images/slider3.jpg);">
            <div style="position:relative;height:550px;width:1200px;margin:0 auto;">
    ...
    <div class="free_composing_content w1200">
        ...
        <div class="product_service mt50" style="width:100%;height:300px; margin:0 auto;">
            <div class="ps-item" style="background:#fff url(/Application/Home/View/Public/images/rcorner_1.png) no-repeat right top;">
                ...
                <a class="askbtn"><div class="ps-item-btn wow bounceIn" style="background: url(/Application/Home/View/Public/images/button1.png);">点击咨询</div></a>
            </div>
            <div class="ps-item" style="background:#fff url(/Application/Home/View/Public/images/rcorner_2.png) no-repeat right top;">
                ...
                <a class="askbtn"><div class="ps-item-btn wow bounceIn" style="background: url(/Application/Home/View/Public/images/button2.png);">点击咨询</div></a>
            </div>
            <div class="ps-item" style="background:#fff url(/Application/Home/View/Public/images/rcorner_3.png) no-repeat right top;">
                ...
                <a class="askbtn"><div class="ps-item-btn wow bounceIn" style="background: url(/Application/Home/View/Public/images/button3.png);">点击咨询</div></a>
            </div>
            <div class="ps-item" style="background:#fff url(/Application/Home/View/Public/images/rcorner_4.png) no-repeat right top;">
                ...
                <a class="askbtn"><div class="ps-item-btn wow bounceIn" style="background: url(/Application/Home/View/Public/images/button4.png);">点击咨询</div></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="free_composing_content w1200">
        ...
        <div class="mt50 advance" style="width:100%; margin:0 auto;">
            ...
            <div class="advance-item">
                ...
                <div class="advance-item-title">无忧售后服务</div>

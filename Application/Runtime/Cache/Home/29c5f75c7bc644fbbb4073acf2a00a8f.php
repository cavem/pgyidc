 ...
 * Submenu
 ...
 .submenu .onthis{background: #60aff6;color: #FFF;}
...
.table>tbody>tr>td{vertical-align: middle;font-size: 16px;padding: 16px;}
</style>
...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">支付方式</h2>
    ...
    <div class="w1200">
        <ul id="accordion" class="accordion">
            ...
            <li class="open">
                ...
                <ul class="submenu" style="display: block;">
                    <li><a href="<?php echo U('Index/paytype');?>" class="onthis">支付方式 </a></li>
                </ul>
            </li>
        </ul>
        <div class="accordion-contain">
            <table class="table table-hover">
                <tbody>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/9296a2e30112d31bb37d123afe7676f4.png" width="116px;"></td>
                        <td>账号：  pgyidccw</td>
                    </tr>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/20160922105732_3223.png" width="116px;"></td>
                        <td> 账 号： 24455088    杨文山</td>
                    </tr>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/20160922110757_4310.png" width="116px;"></td>
                        <td> 账 号： 24455088    杨文山</br>账 号： 2851391898@qq.com    陶磊</td>
                    </tr>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/201407071059529218.gif"></td>
                        <td>卡 号： 1341719980110041102   杨文山</td>
                    </tr>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/201407071100235468.gif"></td>
                        <td>卡 号：  6228453460032628918    杨文山</td>
                    </tr>
                    <tr>
                        <td><img src="/Application/Home/View/Public/images/9f4558ca2e65960f8d5b5dcd17e4f1d0.jpg"></td>
                        <td>卡 号：  6228453460032628918    杨文山</td>
                    </tr>
                </tbody>
            </table>

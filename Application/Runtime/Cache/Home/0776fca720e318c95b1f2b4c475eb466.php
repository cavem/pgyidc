              ...
              <div class="navigation-inner">
                <div class="navigation-v3">
                  <ul>
                    ...
                    <li><h2><a href="<?php echo U('Index/newactive');?>">最新活动</a></h2></li>
...
<style>
.head-item{width: 280px;height:150px;float: left;margin-left:26px;}
.head-item:first-child{margin-left: 0;}
.intro-item{width: 340px;height: 414px;float: left;margin-left:90px;}
.intro-item:first-child{margin-left: 0;}
.advance-item{width: 300px;height: 200px;background: #fff;float: left;}
.product-item{width: 280px;height: 100;float: left;margin-left: 26px;}
...
<div style="width: 100%;height: 550px;">
    <div class="item active" style="background-image:url(/Application/Home/View/Public/images/slider4.jpg);">
        <div style="position:relative;height:550px;width:100%;margin:0 auto;">
            <a href="<?php echo U('Index/newserver');?>" style="width: 220px; height: 60px;position: absolute;bottom: 105px;left: 380px;"></a>
        </div>
    </div>
</div>
<div class="free_composing pt50 pb50">
    <div class="free_composing_content w1200">
        <div class="head-item"><img src="/Application/Home/View/Public/images/active1.jpg" width="100%"></div>
        <div class="head-item"><img src="/Application/Home/View/Public/images/active2.jpg" width="100%"></div>
...
<div class="free_composing pt50 pb50" style="background-color:#fff;">
    <div class="free_composing_content w1200">
        ...
        <div class="mt50 intro" style="width:100%; margin:0 auto;">
            <div class="intro-item"><img src="/Application/Home/View/Public/images/intro_1.jpg" width="100%"></div>
            <div class="intro-item"><img src="/Application/Home/View/Public/images/intro_2.jpg" width="100%"></div>
            <div class="intro-item"><img src="/Application/Home/View/Public/images/intro_3.jpg" width="100%"></div>
        </div>
    </div>
</div>
<!--八大优势-->
<div class="free_composing pt50 pb50" style="background-color:#fff;">
    <div class="free_composing_content w1200">
        ...
        <div class="mt50 advance" style="width:100%; margin:0 auto;">
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_1.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_2.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_3.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_4.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_5.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_6.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_7.jpg"></div>
            <div class="advance-item"><img src="/Application/Home/View/Public/images/advance_8.jpg"></div>
        </div>
    </div>
</div>
<!-- 推荐产品 -->
<div class="free_composing pt50 pb50" style="background-color:#fff;">
    <div class="free_composing_content w1200">
        ...
        <div class="mt50 product" style="width:100%; margin:0 auto;">
            <div class="product-item"><a href="<?php echo U('Index/serverbuy');?>"><img src="/Application/Home/View/Public/images/product1.jpg" width="100%"></a></div>
            <div class="product-item"><a href="<?php echo U('Index/serverbuy');?>"><img src="/Application/Home/View/Public/images/product2.jpg" width="100%"></a></div>
            <div class="product-item"><a href="<?php echo U('Index/serverbuy');?>"><img src="/Application/Home/View/Public/images/product3.jpg" width="100%"></a></div>
            <div class="product-item"><a href="<?php echo U('Index/serverbuy');?>"><img src="/Application/Home/View/Public/images/product4.jpg" width="100%"></a></div>
        </div>

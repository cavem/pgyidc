...
<div class="banner">
    <div class="banner-contain w1200 pr">
        ...
        <div class="bc-right tl pa" style="left:200px;top:20px;">
            <h2 class="m0 wow fadeInUp">荣誉资质</h2>
...
<div class="main">
    <div class="w1200">
        <img src="/Application/Home/View/Public/images/最新营业执照副本-宿迁蒲公英网络有限公司.jpg" width="100%">
        <img src="/Application/Home/View/Public/images/honer_1.jpg" width="100%">
        <img src="/Application/Home/View/Public/images/honer_2.jpg" width="100%">
    </div>
</div>
<!--左右悬浮-->
<style>
